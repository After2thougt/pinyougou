					...
					<div class="summary">
						...
						<div class="summary-wrap">
							...
							<div class="fl fix-width">
								<i class="red-bg">加价�?</i>
								<em class="t-gray">�?999.00另加20.00元，或满1999.00另加30.00元，或满2999.00另加40.00元，即可在购物车�?
购热�?商品</em>
							</div>
						</div>
					</div>
					<div class="support">
						<div class="summary-wrap">
							...
							<div class="fl fix-width">
								<em class="t-gray">以旧换新，闲置手机回�?  4G套餐超�?�抢  礼品�?</em>
							</div>
						</div>
						<div class="summary-wrap">
							<div class="fl title">
							...
							<dl>
								...
								<#list spec.attributeValue as item>
									<dd><a href="javascript:;" class="{{isSelected('${spec.attributeName}','${item}')?'selected':''}}" 
										ng-click="selectSpecificationItem('${spec.attributeName}','${item}')">${item}
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a  class="sui-btn  btn-danger addshopcar" ng-click="addToCart()">加入购物�?</a>
									</li>
								</ul>
							</div>
						</div>
							...
							<ul class="goods-list unstyled">
								<li>
									<div class="list-wrap">
										...
										<div class="operate">
											<a href="javascript:void(0);" class="sui-btn btn-bordered">加入购物�?</a>
										</div>
									</div>
								</li>
								<li>
    ...
    <input type="checkbox"><span>99</span>
							...
							<div class="fr result">
								<div class="num">已�?�购0件商�?</div>
								<div class="price-tit"><strong>套餐�?</strong></div>
								<div class="price">�?5299</div>
								<button class="sui-btn  btn-danger addshopcar">加入购物�?</button>
							</div>
						</div>
					</div>
					...
					<ul class="yui3-g">
						<li class="yui3-u-1-6">
							<div class="list-wrap">
								...
								<div class="attr">
									<em>DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记�?</em>
								</div>
								<div class="price">
									<strong>
											<em>¥</em>
	...
	<div class="toolbar-wrap J-wrap">
		<div class="toolbar">
			<div class="toolbar-panels J-panel">
				...
				<div style="visibility: hidden;" class="J-content toolbar-panel tbar-panel-cart toolbar-animate-out">
					<h3 class="tbar-panel-header J-panel-header">
						<a href="" class="title"><i></i><em class="title">购物�?</em></a>
					...
					<div class="tbar-panel-main">
						<div class="tbar-panel-content J-panel-content">
							<div id="J-cart-tips" class="tbar-tipbox hide">
								<div class="tip-inner">
									<span class="tip-text">还没有登录，登录后商品将被保�?</span>
					...
					<div id="cart-footer" class="tbar-panel-footer J-panel-footer">
						<div class="tbar-checkout">
							<div class="jtc-number"> <strong class="J-count" id="cart-number">0</strong>件商�? </div>
							...
							<div class="jt-history-wrap">
								<ul>
									<!--<li class="jth-item">
										...
										<a class="add-cart-button" href="#" target="_blank">加入购物�?</a>
			...
			<div class="toolbar-tabs J-tab">
				<div onclick="cartPanelView.tabItemClick('cart')" class="toolbar-tab tbar-tab-cart" data="购物�?" tag="cart" >
					<i class="tab-ico"></i>
...
<script type="text/template" id="tbar-cart-item-template">
	<div class="tbar-cart-item" >
		<div class="jtc-item-promo">
			...
			<div class="promo-text">已购�?600元，您可领赠�?</div>
		</div>
